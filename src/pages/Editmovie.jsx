                  ...
                  <nav className="m-0 bg-gray-200 cursor-pointer">
                    ...
                    <div className="flex flex-col items-center justify-center bg-gray-200 h-screen">                         
                            <div className="flex h-[400px] w-[350px] flex-col justify-between items-center mx-auto bg-white rounded-md">
                                <input  className="text-center h-8 w-64 border-blue-200 border-2 rounded-md outline-none mt-12 text-[14px]"  type="text" placeholder="new Movie Title"                  onChange={(e)=>setNewOrginalTitle(e.target.value)}           />
                                <input  className="text-center h-8 w-64 border-blue-200 border-2 rounded-md outline-none text-[14px]" type="text" placeholder="new Description"                         onChange={(e)=>setNewDescription(e.target.value)}           />
                                <input  className="text-center h-8 w-64 border-blue-200 border-2 rounded-md outline-none text-[14px]" type="text"  placeholder="new Release(yyyy-mm-dd)"                       onChange={(e)=>setReleaseDate(e.target.value)}           />
                                <input  className="text-center h-8 w-64 border-blue-200 border-2 rounded-md outline-none text-[14px]"  type="number"  placeholder="Duration(in minuts)"                 onChange={(e)=>setNewRunTimeMinutes(e.target.value)}           />
                                <input  className="text-center h-8 w-64 border-blue-200 border-2 rounded-md outline-none text-[14px]" type="number"  placeholder="Rating(out of 5)"                             onChange={(e)=>setNewAverageRating(e.target.value)}           />
                                <input  className="text-center h-8 w-64 border-blue-200 border-2 rounded-md outline-none mb-12 text-[14px]"type="text" placeholder="new image link"                     onChange={(e)=>setNewImageLink(e.target.value)}           />                               
                            </div>
