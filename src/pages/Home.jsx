    ...
    return<div className="h-full w-full">
             ...
             <div className="absolute bg-black h-fit w-full content-center items-center justify-center">
                 ...
                 <span className="relative jutify-between items-center flex flex-row">
                  ...
                  <div className="absolute ml-[650px] mt-42 text-xl   w-82 h-[40px] text-center content-center font-medium text-black z-10 rounded-full bg-yellow-500 cursor-pointer" onClick={()=>Navigate("/signin",{replace:true})}>SignUp / Signin for more access </div>
