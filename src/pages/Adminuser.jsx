            ...
            <Toaster possition="top-center"  reverseOrder={false}/>
             <nav className="justify-between flex items-center bg-black text-white">
                 <span className="cursor-pointer"> <img src={imdblogo} alt="imdb logo " /></span>
                     <span ><input className="bg-white w-[200px] md:w-[400px] text-black outline-blue-200 rounded-md" placeholder="🔎 Search Movie by Title" type="text" value={titlesearch}  onChange={(e)=>{setTitlesearch(e.target.value);setIsSearching(true);Setpage(1)}}/></span>
                     ...
                     <span ><input className=" hidden md:flex bg-white w-[400px] text-black outline-blue-200 rounded-md" placeholder="🔎 Search Movie by Description" type="text" value={descriptionsearch} onChange={(e)=>{setDescriptionsearch(e.target.value);setIsSearching(true);Setpage(1)}}/></span>
